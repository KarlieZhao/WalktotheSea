...
function loadSentences(){
  ...
  sentences[1]="All of the memories come back while thinking about the word “(sea)”: the wet breeze {calmly} blowing on the beach, the [smell] of seaweed. {The wearied creatures rest} underneath the boiling hot sand grains, and everything.";
  ...
  sentences[6]="(The ocean), a place that has companied you since [you were a kid]. When the little you {wept} alone in your troubles the sadness, softly, the ocean responds {in the depth}.";
  ...
  sentences[15]="(Sink) into the water. What is that glitchy tiny thing down {there}? A [jellyfish]?";
  sentences[16]="You reach out to touch the (jellyfish). But it’s too late when you figure out it’s not a creature. Look around, you find that you are surrounded by […]";
  sentences[17]="All of the (memories) are [fading away]. The feeling of the fine sand {beneath} your feet, the sound of {the dark blue waves} crawling gently to the shore, [and everything].";

  sentences[18]="This is your trip, to the deep blue sea.";
  sentences[19]="[Everything will be start over.]";
